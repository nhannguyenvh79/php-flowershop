        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-4xl font-bold text-gray-900 dark:text-white">
                    <i class="fas fa-edit text-teal-500 mr-3"></i>Chỉnh sửa sản phẩm
                </h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Cập nhật thông tin sản phẩm</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                            <label for="image" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                <i class="fas fa-upload text-purple-500 mr-2"></i>Chọn ảnh mới
                            </label>
                            <input type="file" 
                        ...
                        @if($product->image)
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    <i class="fas fa-check-circle text-green-500 mr-2"></i>Ảnh hiện tại
                                </label>
                                <div class="relative group">
                                    <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}"
                                        class="w-full h-48 object-cover rounded-lg border-2 border-teal-200 dark:border-teal-700 shadow-sm group-hover:shadow-lg transition-shadow duration-200">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">{{ $product->image }}</p>
                            </div>
                        @endif
                    </div>
                </div>
    ...
    document.getElementById('image').addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                preview.innerHTML = `
                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Xem trước ảnh mới:</p>
                    <div class="relative group">
