            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-4xl font-bold text-gray-900 dark:text-white">
                        <i class="fas fa-layer-group mr-3 text-pink-500"></i>{{ $brand->name }}
                    </h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">ID: <span class="font-semibold">#{{ $brand->id }}</span></p>
                </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-300">{{ $brand->description ?: 'Chưa có mô tả' }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            @if($brand->website)
                                <a href="{{ $brand->website }}" target="_blank" class="text-blue-600 dark:text-blue-400 hover:underline">
                                    {{ $brand->website }}
                                </a>
                            @else
                                <p class="text-gray-500 dark:text-gray-400">Chưa có website</p>
                            @endif
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-700 dark:text-gray-300">
                                    {{ $brand->created_at->format('d/m/Y') }}<br>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">{{ $brand->created_at->format('H:i') }}</span>
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700 dark:text-gray-300">
                                    {{ $brand->updated_at->format('d/m/Y') }}<br>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">{{ $brand->updated_at->format('H:i') }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h2 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                            <i class="fas fa-box mr-3 text-blue-500"></i>Sản Phẩm ({{ $brand->products->count() }})
                        </h2>
                    </div>
                    <div class="overflow-x-auto">
                        ...
                        @else
                            <div class="px-6 py-12 text-center">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">Chưa có sản phẩm trong thương hiệu này</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="bg-gradient-to-r from-indigo-50 to-indigo-100 dark:from-indigo-900/30 dark:to-indigo-800/30 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h2 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                            <i class="fas fa-image mr-3 text-indigo-500"></i>Hình Ảnh Logo
                        </h2>
                    </div>
                    <div class="p-6">
                        @if($brand->image)
                        ...
                        @else
                            <div class="w-full h-48 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
                        ...
                        @if($brand->is_active)
                            <div class="flex items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-green-700 dark:text-green-300">Thương hiệu này đang hiển thị</p>
                                </div>
                            </div>
                        @else
                            <div class="flex items-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-red-700 dark:text-red-300">Thương hiệu này đã ẩn</p>
                                </div>
                            </div>
                        @endif
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mt-6">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ $brand->products->count() }}</span>
                        </div>
                        <hr class="border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <span class="text-gray-600 dark:text-gray-400">Sản Phẩm Đang Bán</span>
                            <span class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $brand->products->where('is_active', true)->count() }}</span>
                        </div>
                        <hr class="border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <span class="text-gray-600 dark:text-gray-400">Sản Phẩm Ngưng Bán</span>
                            <span class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $brand->products->where('is_active', false)->count() }}</span>
                        </div>
                    </div>
                </div>
            </div>
