    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Bắt đầu ngay</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Laravel có một hệ sinh thái vô cùng phong phú.
                    <br>Chúng tôi đề xuất bạn bắt đầu với các mục sau.</p>
